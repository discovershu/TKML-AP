...
if __name__ == '__main__':
    ...
    parser.add_argument('--results', default='woSigmoid-BCE-Adam-bs128-box_-1_1_COCO_fixMem', help='path to dataset') ##woSigmoid-BCE-Adam-bs64-box_-1_1, woSigmoid-BCE-Adam-bs128-box_-1_1_COCO_fixMem
    ...
    parser.add_argument('--remove_tier_para', default=0.01, type=float, help='remove_tier_para')
